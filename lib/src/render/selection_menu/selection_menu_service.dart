...
class SelectionMenu implements SelectionMenuService {
  ...
  void show() {
    ...
    final menuHeight = selectionMenuItems.length ~/ 3 * 80.0 + 10.0;
    ...
    _selectionMenuEntry = OverlayEntry(
      builder: (context) {
        return Positioned(
          top: showBelow ? _offset.dy - editorOffset.dy : null,
          bottom: showBelow ? null : _offset.dy,
          left: offset.dx - editorOffset.dx,
          right: 0,
